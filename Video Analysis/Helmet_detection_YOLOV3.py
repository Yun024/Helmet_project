...
from matplotlib import pyplot as plt # jam 
...
classesFile = "/content/drive/My Drive/smartcity_project/헬멧수 반환 by YOLOv3/obj.names";
classes = None
...
modelConfiguration = "/content/drive/My Drive/smartcity_project/헬멧수 반환 by YOLOv3/yolov3-obj.cfg";
modelWeights = "/content/drive/My Drive/smartcity_project/헬멧수 반환 by YOLOv3/yolov3-obj_2400.weights";
...
def postprocess(frame, outs):
    ...
    if count_person >= 1:
        ...
        #print(type(frame))
        cv.imshow('img',frame) #jam
#         plt.imshow(frame,'img') #jam
